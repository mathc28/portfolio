...
import Vuejs from "../../assets/logo-techno/logo-vue.svg"
            ...
            <div className='container-compétences'>
                <div className='web-skills'>
                    ...
                    <div className='skills'> 
                        ...
                        <div className='skill'>
                            <img src={Vuejs} alt="logo vue.js" className='logo-techno' />
                            <div className='techno-info'>
                                <h3 className='skill-title'>Vue.js</h3>
                    ...
                    <div className='skills2'> 
                        <div className='skill'>
                            ...
                            <div className='techno-info'>
                                ...
                                <p className='level'> {t('lvldeb')} </p>
                                <div className='stars'>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>                                        <img src={Fullstar} alt="une étoile pleine" className='star'/>
                                    <img src={Emptystar} alt="une étoile vide" className='star'/>
                                    <img src={Emptystar} alt="une étoile vide" className='star'/>
                                    <img src={Emptystar} alt="une étoile vide" className='star'/>
                                </div>
                        ...
                        <img src={Github} alt="loho react" className='logo-techno' />
                            <div className='techno-info'>
                                ...
                                <div className='stars'>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>                                        <img src={Emptystar} alt="une étoile vide" className='star'/>
                                    <img src={Emptystar} alt="une étoile vide" className='star'/>                                        <img src={Emptystar} alt="une étoile vide" className='star'/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='web-skills'>
                    ...
                    <div className='skills2'> 
                        ...
                        <div className='skill'>
                            ...
                            <div className='techno-info'>
                                <h3 className='skill-title'> Newsletter </h3>                                    <p className='level'> {t('lvlavan')} </p>
                                <div className='stars'>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>
                                    <img src={Fullstar} alt="une étoile pleine" className='star'/>
